        ...
        <div className="max-w-6xl mx-auto flex flex-col gap-12 relative z-10">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <form
              ...
              className="bg-white rounded-2xl shadow-lg p-10 space-y-6 animate-fade-in-up border border-primary-100 w-full"
          ...
          {/* Row 2: Get in Touch Info and Map side by side */}
          <div className="grid md:grid-cols-2 gap-8 items-start">
            {/* Get in Touch Info */}
            <div className="bg-primary-50 rounded-2xl shadow-lg p-10 animate-fade-in-up flex flex-col h-full justify-between">
            ...
            {/* Google Maps Embed */}
            <div className="rounded-2xl overflow-hidden shadow-lg animate-fade-in-up flex justify-center items-center bg-white p-2">
              <iframe
